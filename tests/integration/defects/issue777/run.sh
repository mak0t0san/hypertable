...
$HT_HOME/bin/stop-servers.sh --only-thriftbroker
check_running Hypertable.Master
check_running Hypertable.RangeServer
check_running Hyperspace.Master
...
$HT_HOME/bin/stop-servers.sh --only-thriftbroker --only-master
...
$HT_HOME/bin/stop-servers.sh --only-rangeserver
check_killed  Hypertable.Master
...
$HT_HOME/bin/stop-servers.sh --only-hyperspace --only-dfsbroker
check_killed  Hypertable.Master
check_killed  Hypertable.RangeServer
